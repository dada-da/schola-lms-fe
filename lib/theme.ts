...
const theme = createTheme({
  ...
  typography: {
    ...
    h1: { fontFamily: 'var(--font-serif), Georgia, serif', fontWeight: 400 },
    h2: { fontFamily: 'var(--font-serif), Georgia, serif', fontWeight: 400 },
    h3: { fontFamily: 'var(--font-serif), Georgia, serif', fontWeight: 400 },
    h4: { fontFamily: 'var(--font-serif), Georgia, serif', fontWeight: 400 },
    h5: { fontFamily: 'var(--font-serif), Georgia, serif', fontWeight: 400 },
    h6: { fontWeight: 600 },
