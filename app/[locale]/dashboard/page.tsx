...
const UPCOMING = [
  {
    ...
    sub: 'Live · 3:00 PM · 42 attending',
  },
  {
    day: '5',
    mon: 'Apr',
    title: 'UX Research Q&A',
    sub: 'Cohort · 11:00 AM · 18 attending',
  },
  {
    day: '8',
    mon: 'Apr',
    title: 'React performance deep-dive',
    sub: 'Live · 2:00 PM · 56 attending',
  },
];
const ANNOUNCEMENTS = [
  {
    ...
    color: '#e1f2ef',
    textColor: '#1f6257',
    title: '5 new Python courses added',
    time: '2 hours ago',
  },
  {
    tag: 'Event',
    color: '#faeaec',
    textColor: '#8a3040',
    title: 'ScholaConf 2025 — early bird open',
    time: 'Yesterday',
  },
  {
    tag: 'Update',
    color: '#e8f0fa',
    textColor: '#1d4f7a',
    title: 'AI tutor now supports code review',
    time: '3 days ago',
  },
];
const CERTS = [
...
export default function Dashboard() {
  ...
  const METRICS = [
    ...
    },
    {
      ...
      value: '87%',
      delta: '↑ 5pts improvement',
      up: true,
    },
    {
      label: t('dayStreak'),
      value: '23 🔥',
      delta: t('personalBest'),
      up: true,
    },
  ];
              ...
              <Card>
                <CardContent sx={{ p: 1.75, '&:last-child': { pb: 1.75 } }}>
                  ...
                  <Typography
                    variant="caption"
                    sx={{
                      color: m.up ? 'success.main' : 'error.main',
                      fontWeight: 500,
                    }}
                  >
                    {m.delta}
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          bgcolor: i === 4 ? 'primary.main' : 'primary.light',
                          height: `${Math.round((h / MAX_ACT) * 100)}%`,
                          mt: 'auto',
                          cursor: 'pointer',
                ...
                {LEADERBOARD.map((p, i) => (
                  <Box
                    ...
                    sx={{
                      ...
                      py: 0.75,
                      borderBottom:
                        i < LEADERBOARD.length - 1 ? '1px solid' : 'none',
                      borderColor: 'divider',
                    }}
                  >
                    <Typography
                      sx={{
                        fontSize: '0.72rem',
                        fontWeight: 700,
                        color: i === 0 ? '#c8a96e' : 'text.disabled',
                        width: 16,
                        textAlign: 'center',
                      }}
                    >
            ...
            {inProgress.map((c, i) => (
              <Box
                ...
                sx={{
                  ...
                  py: 1,
                  borderBottom:
                    i < inProgress.length - 1 ? '1px solid' : 'none',
                  borderColor: 'divider',
                  cursor: 'pointer',
                  '&:hover': {
              ...
              >
                ...
                <Box sx={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    Module {c.module} of {c.totalModules} · {c.lastStudied}
                  </Typography>
                </Box>
                ...
                {UPCOMING.map((s, i) => (
                  <Box
                    ...
                    sx={{
                      ...
                      py: 0.875,
                      borderBottom:
                        i < UPCOMING.length - 1 ? '1px solid' : 'none',
                      borderColor: 'divider',
                    }}
                  >
                    <Box
                ...
                {ANNOUNCEMENTS.map((a, i) => (
                  <Box
                    ...
                    sx={{
                      py: 0.75,
                      borderBottom:
                        i < ANNOUNCEMENTS.length - 1 ? '1px solid' : 'none',
                      borderColor: 'divider',
                    }}
                  >
                    <Chip
                ...
                {CERTS.map((c, i) => (
                  <Box
                    ...
                    sx={{
                      ...
                      gap: 1,
                      py: 0.875,
                      borderBottom: i < CERTS.length - 1 ? '1px solid' : 'none',
                      borderColor: 'divider',
                    }}
                  >
                    <Box
